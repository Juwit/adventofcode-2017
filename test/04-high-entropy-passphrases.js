...
let myInput = `oaoe rxeq vssdqtu xrk cjv yaoqp loo
...
describe("passphrase", () => {
    ...
    it("should validate aa bb cc dd ee", () => {
        ...
        expect(isValid(pass)).to.be.true;
    });

    it("should not validate aa bb cc dd aa", () => {
        let pass = "aa bb cc dd aa";
        expect(isValid(pass)).to.be.false;
    });
    ...
    it("should give the answer", () => {
        ...
        let valid = allPassphrases.filter(isValid).length;
        console.log(valid);
    });
